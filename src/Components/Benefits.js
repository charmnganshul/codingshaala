        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 gap-20 w-full'>
                <div className='flex w-[90%] py-4 border min-h-[20vh] lg:ml-0 ml-[10%]'>
                    ...
                    <div className='flex gap-4 flex-col py-4 px-4 ml-[-20px]'>
                        ...
                        <label>Start working on Live project <br></br> from Day 1</label>
                ...
                <div className='flex w-[90%] py-4 border min-h-[20vh] lg:ml-0 ml-[10%]'>
                    ...
                    <div className='flex gap-4 flex-col py-4 px-4 ml-[-20px]'>
                        ...
                        <label>Complete projects independently by 7th week &  <br></br> become a Developer by 8th week!</label>
                ...
                <div className='flex w-[90%] py-4 border min-h-[20vh] lg:ml-0 ml-[10%]'>
                    ...
                    <div className='flex gap-4 flex-col py-4 px-4 ml-[-20px]'>
                        ...
                        <label>Classroom training 8 hours, 5 days a week with <br></br> inhouse trainer</label>
                ...
                <div className='flex w-[90%] py-4 border min-h-[20vh] lg:ml-0 ml-[10%]'>
                    ...
                    <div className='flex gap-4 flex-col py-4 px-4 ml-[-20px]'>
                        ...
                        <label>Training for Interviews, client communication, <br></br> Presentation</label>
                ...
                <div className='flex w-[90%] py-4 border min-h-[20vh] lg:ml-0 ml-[10%]'>
                    ...
                    <div className='flex gap-4 flex-col py-4 px-4 ml-[-20px]'>
                        ...
                        <label>Get a certificate of Training <br></br> after completion</label>
                ...
                <div className='flex w-[90%] py-4 border min-h-[20vh] lg:ml-0 ml-[10%]'>
                    ...
                    <div className='flex gap-4 flex-col py-4 px-4 ml-[-20px]'>
                        ...
                        <label>Preparing for Personal Interviews, Technical rounds, <br></br> communication</label>
